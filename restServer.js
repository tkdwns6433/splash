...
app.get('/magnet', cors(corsOption), (req, res) => {
	...
	torrent.on('progress', function() {
		console.log('downloading files : ' + torrent._files);
		console.log('progress : ' + torrent.stats.downloaded / torrent.size + '%');
	})
	.on('complete', function(){
		console.log('complete download');
		torrent.files.forEach(function(file){
			var newPath = 'vods/downloads/' + file.path;
